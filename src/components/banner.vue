...
export default {
  ...
  methods: {
    ...
    initBanner() {
      ...
      if (this.loop) {
        ...
        this.translateOffset =
          (clientWidth + this.itemSpacing) * (this.curItemIndex + 1);
    ...
    touchmove(evt) {
      ...
      this.translateX =
        -this.offsetX +
        (clientWidth + this.itemSpacing) * this.curItemIndex +
        this.translateOffset;
    },
    // touchend事件
    touchend(evt) {
    ...
    translate(curItemIndex) {
      ...
      this.speed = 500;
      this.translateX =
        (clientWidth + this.itemSpacing) * curItemIndex + this.translateOffset;
