    ...
    <div class="playDetail" :style="{'background-image': 'url(' + curPlayImgSrc + ')'}" v-if="showDetail">
      ...
      <div class="playDetail-bottom">
        ...
        <div class="lrcColor-box">
          <div class="cur-lrcColor" :style="{backgroundImage: 'url('+ currentImgSrc +')'}" @click="isShowColorList = !isShowColorList">
          </div>
          ...
          <div class="list-detail">
            ...
            <transition name="fade">
              <div class="play-list" v-if="isShowList">
                <ul>
                  <li v-for="(song, index) of songList" :key='index' :class="{active: curPlayIndex === index}" @click="playSong(index)">
...
<script>
  ...
  export default {
        ...
        lrcColorList: [           // 歌词颜色列表数组
          {
            defaultColor: "#b2f5b5",
            activeColor: "#d1c90e",
            currentImgSrc: require("../../static/img/current-type1.png")
          },
          {
            defaultColor: "#c1f3dc",
            activeColor: "#33a3f5",
            currentImgSrc: require("../../static/img/current-type2.png")
          },
          {
            defaultColor: "#a0f533",
            activeColor: "#f32d2d",
            currentImgSrc: require("../../static/img/current-type3.png")
          },
          {
            defaultColor: "#eff366",
            activeColor: "#21d10e",
            currentImgSrc: require("../../static/img/current-type4.png")
          },
          {
            defaultColor: "#efe8b2",
            activeColor: "#d200d2",
            currentImgSrc: require("../../static/img/current-type5.png")
          }
        ]
      };
    },
    computed: {
      ...
      ...mapGetters(["curPlayFileName", "listTotal"]),
      songData() {
    ...
    methods: {
      ...
      updateProgress(evt) {
        ...
        this.curPlayTime = parseInt(
          (this.endTime * this.progress / 100).toFixed(2)
        );
