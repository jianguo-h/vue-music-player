<template>
    ...
    class="collect" 
    :class = "{
        collected: routerPath !== 'collect' && songData.collected, 
        deleted: routerPath === 'collect' && !showDetail, 
        'collected-detail': showDetail
    }"
    @click.stop = "collect">
